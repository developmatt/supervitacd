...
<body class="index">
    <div id="page-content">
        ...
        <section id="best" class="important">
            <div class="wrapper">
                ...
                <div class="important__row display--flex align-items--flex-start justify-content--space-between">
                    ...
                    <div class="important__col important__col-image">
                        <img src="/images/banana-marker.png" alt="" class="important__fruit">
                    </div>
                        
                    <div class="important__col important__col-text">

                        <h3 class="important__topic">Fácil mastigação</h3>

                        <p class="important__text">Ao contrário das cápsulas que você encontra no mercado, as gomas proporcionam a ingestão e absorção de vitaminas e minerais indispensáveis para o crescimento e desenvolvimento infantil. </p>

                        <p class="important__complement">Em comparação as cápsulas, as vitaminas em gomas são bastante fáceis de mastigar e engolir sendo um facilitador, sem ter nenhum sabor desagrável como é o caso das cápsulas.</p>
                    </div>

                    <div class="important__col">
                        <img src="/images/important-kid.png" alt="" class="important__kid">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section id="release" class="release">
            ...
            <h3 class="release__subtitle">Polivitamínico infantil delicioso para crianças. <span class="bold">Suplemento alimentar em goma de pectina</span>.</h3>
                            ...
                            <div class="column__data-row">
                                <div class="column__data column__data--parcels-div">
                                    <span class="column__data--parcels">
                                        <span class="bold"><span class="big">6</span>X</span> SEM JUROS DE</span>
                                </div>
